...
- `metadata.robots` in the root layout, opting into `max-image-preview: large` so Google's SERP entry shows the full-size OG card instead of the small default preview (#143).
