...
| `npm run knip` | Check for unused files, exports, and dependencies with [`knip`](https://knip.dev) (config: [`knip.json`](./knip.json)). Gated in CI on every PR and push to `main`. |
